        ...
        <div class="container">
            ...
            <div class="d-flex d-block d-sm-flex review">
                <div>
                	...
                	<a class="boarda" href="<%=path%>/beach/revdel?replyNo=<%=br.getBCH_REVIEW_NO()%>">삭제</a>
                	<%
          		    }
                	%>
                </div>
